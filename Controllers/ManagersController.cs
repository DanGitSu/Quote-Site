...
namespace Goals_Site.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Phone")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Phone")] Manager manager)
        {
            if (id != manager.ID)
            {
                return NotFound();
