...
namespace Goals_Site.Controllers
{
    public class SitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Address,Contact_Name,Contact_Phone,Stairs,Lift,Loading_Dock")] Site site)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("ID,Address,Contact_Name,Contact_Phone,Stairs,Lift,Loading_Dock")] Site site)
        {
            if (id != site.ID)
            {
                return NotFound();
