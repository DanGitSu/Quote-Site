...
namespace Goals_Site.Controllers
{
    public class SitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SiteId,Name,Address,Contact_Name,Contact_Phone,Stairs,Lift,Loading_Dock")] Site site)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SiteId,Name,Address,Contact_Name,Contact_Phone,Stairs,Lift,Loading_Dock")] Site site)
        {
            if (id != site.SiteId)
            {
                return NotFound();
